...
*cd "DIR"  /* adjust the CD as needed*/
cd "DIR"

use "Data_Curb_EU.dta", clear  /*load the data*/

*label data "This file contains replication data for the article Curb EU Enthusiasm, 2024, West European Politics" 
 
** set plotting scheme
set scheme plotplain  

label variable NEW_LR_Proposal_Probability  "Probability of EU authority expanstion by act"
label variable support_ms_mean "Public support at t-2 of proposal"
label variable sal_ms_mean "Public salience at t-1 of proposal"
label variable pol_ms_mean "Public polarisation at t-1 of proposal"
label variable mob_ms_count "Actor mobilisation at t-1 of proposal, excl. business"
label variable interinst_conflict "Absolute distance between the weighted mean positions of the EP and the Council"
label variable competence_length "Years of EU competence in the policy area of the act"
label variable nofterms_in_eurovoc "Complexity: number of EuroVoc terms attached to the proposal"
label variable mob_ms_count_all_org "Actor mobilisation at t-1 incl. business"
label variable mob_ms_mean_hhi "Actor mobilisation based on Herfindahl-Hirschman Index"
label variable form_num "Legal instrument: 1=decision; 2=Directivel 3=Regulation" 
label variable support_ms_mean_lag1y "Public support at t-1 of proposal"
label variable sal_ms_mean_no_lag "Public salience at t of proposal"
label variable pol_ms_mean_no_lag "Public polarisation at t of proposal"
label variable mob_ms_count_no_lag "Actor mobilisation at t of proposal, excl. business"
label variable ep_term_full "EP term: 7=7th EP term; 8=8th EP term"
label variable  CH_conflict_med_party_epg "Abs dist EP(median party del. in median EPG) - furthest CN pivot gov on EU dim OR distance b/n furthest CN pivots when EP position is sutuated in between them"
label variable support_ms_w "Weighted average public support based on countries' voting weights in Council"
